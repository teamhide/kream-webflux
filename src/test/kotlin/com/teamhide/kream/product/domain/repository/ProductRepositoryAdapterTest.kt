...
class ProductRepositoryAdapterTest : StringSpec({
    ...
    "Product를 저장한다" {
        ...
        // When
        val sut = productRepositoryAdapter.saveProduct(product = product)
    ...
    "id로 ProductCategory를 조회한다" {
        ...
        coEvery { productRepositoryAdapter.findCategoryById(id) } returns productCategory
    ...
    "id로 ProductBrand를 조회한다" {
        ...
        coEvery { productRepositoryAdapter.findBrandById(id) } returns productBrand
